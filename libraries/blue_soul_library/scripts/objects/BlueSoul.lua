...
function BlueSoul:doGravity()
	if self.gravity >= -25 and self.gravity < -6 then self.gravity = self.gravity + 0.25 end
	if self.gravity >= -6 and self.gravity < -0.8 then self.gravity = self.gravity + 0.18 end
	if self.gravity >= -0.8 and self.gravity < 0.8 then self.gravity = self.gravity + 0.12 end
	if self.gravity >= 0.8 and self.gravity < 2.5 then self.gravity = self.gravity + 0.10 end
	if self.gravity >= 2.5 and self.gravity < 6 then self.gravity = self.gravity + 0.16 end
	if self.gravity >= 6 and self.gravity < 13 then self.gravity = self.gravity + 0.23 end
end
